...
export default {
  ...
  methods: {
    ...
    getCoupons() {
      const vm = this;
      const url = `${process.env.APIPATH}/api/${process.env.COUSTOMPATH}/admin/coupons`;
    ...
    updateCoupon() {
      const vm = this;
      if (vm.isNew) {
        const url = `${process.env.APIPATH}/api/${process.env.COUSTOMPATH}/admin/coupon`;
        ...
        const url = `${process.env.APIPATH}/api/${process.env.COUSTOMPATH}/admin/coupon/${vm.tempCoupon.id}`;
